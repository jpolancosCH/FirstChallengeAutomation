...
public class FullStep4 implements Task {
    ...
    private final DataFourthStep dataFourthStep = new DataFourthStep();
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                Enter.theValue(dataFourthStep.password).into(FourthStepPage.INPUT_PASSWORD),
                Enter.theValue(dataFourthStep.confirmPassword).into(FourthStepPage.INPUT_CONFIRMED_PASSWORD),
